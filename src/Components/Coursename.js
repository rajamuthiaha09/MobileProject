          ...
          <View>
            {isRedirected ? (
              ...
              <View style={styles.courseContainer}>
                ...
                <FontAwesomeIcon icon={faHeart} size={25} color="black" style={styles.iconBorder}/>
                <FontAwesomeIcon icon={faHeart} size={18} color="white" style={styles.iconFill}/>
              </View>
            )}
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  paidTag: {
    ...
    paddingHorizontal: 6,
    paddingVertical: 2,
    backgroundColor: '#FFD700', // Yellow for paid
  },
  freeTagText: {
    color: '#fff',
    fontSize: 15,
